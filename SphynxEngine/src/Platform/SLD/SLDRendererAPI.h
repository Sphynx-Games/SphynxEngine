...
namespace Sphynx
{
	...
	public:
		...
		virtual void DrawCircle(Vector2i point, float radius, uint32_t numSegments, Color color) override;
		...
		virtual void DrawCircle(DrawMode drawMode, Vector2i point, float radius, uint32_t numSegments, Color color) override;
